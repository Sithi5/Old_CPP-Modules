...
int main(void) {
    ...
    if (mathieu.getHitPoints() > (unsigned int)0){
        ...
        std::cout << "Bonnes gens, nous avons un vainqueur ! Que tout le monde salue le combattant **" << maboubouce.getName() << "** ! Vainqueur, quittez l'arène et allez vous reposez ! Vous l'avez bien mérité !" << std::endl;
    }
    std::cout << std::endl;
    return 0;
}